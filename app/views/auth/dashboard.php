    ...
    <div class="page-shell">
        <div class="card">
            <h1>
                ...
                Welcome, <?= $session->userdata('username') ?>!
            </h1>
            <span class="badge">Role: <?= $session->userdata('role') ?></span>
            <p class="subtle">Glad to see you back. Everything's right where you left it.</p>
            <a class="btn btn-quiet" href="<?= site_url('auth/logout') ?>">Logout</a>
        </div>
    </div>
</body>
</html>