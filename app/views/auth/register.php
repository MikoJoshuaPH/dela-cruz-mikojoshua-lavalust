...
<body>
    <div class="page-shell">
        <div class="card">
            ...
            <p class="subtle">Just a few details and you're in.</p>
            <?php if (!empty($error)): ?>
                <p class="form-error" role="alert"><?=htmlspecialchars($error, ENT_QUOTES, 'UTF-8');?></p>
            <?php endif; ?>
            <form action="<?=site_url('auth/register');?>" method="post">
                <label for="username">Username</label>
                <input type="text" id="username" name="username" placeholder="Username" value="<?=htmlspecialchars($username ?? '', ENT_QUOTES, 'UTF-8');?>" minlength="3" maxlength="30" pattern="[A-Za-z0-9_]+" required>
                ...
                <select name="role" id="role">
                    ...
                    <option value="admin" <?=($role ?? 'user') === 'admin' ? 'selected' : '';?>>Admin</option>
                </select>
